<div class="container text-center">
    <div class="row">
      ...
      <div class="service-heading-block">
          <h2 class="text-center text-primary title">What We do ?</h2>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="text-center feature-block">
          ...
          <a href="javascript:void(0)" class="btn btn-info btn-custom">Know More</a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
       <div class="text-center feature-block">
          ...
          <h4 class="color-warning">Access Control</h4>
          <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
          <a href="javascript:void(0)" class="btn btn-warning btn-custom">Know More</a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="text-center feature-block">
          ...
          <h4 class="color-success">Boom Barrier</h4>
          <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
          <a href="javascript:void(0)" class="btn btn-success btn-custom">Know More</a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="text-center feature-block">
          ...
          <h4 class="color-danger">Flap Barrier</h4>
          <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
          <a href="javascript:void(0)" class="btn btn-danger btn-custom">Know More</a>
        </div>
      </div>
    </div>  
    ...
    <div class="row">
     ...
     <div class="col-lg-3 col-md-6 col-sm-6">
       <div class="text-center feature-block">
         ...
         <h4 class="color-info">Turnstile</h4>
         <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
         <a href="javascript:void(0)" class="btn btn-info btn-custom">Know More</a>
       </div>
     </div>
     ...
     <div class="col-lg-3 col-md-6 col-sm-6">
      <div class="text-center feature-block">
         ...
         <h4 class="color-warning">Metal Detector</h4>
         <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
         <a href="javascript:void(0)" class="btn btn-warning btn-custom">Know More</a>
       </div>
     </div>
     ...
     <div class="col-lg-3 col-md-6 col-sm-6">
       <div class="text-center feature-block">
         ...
         <h4 class="color-success">Cards</h4>
         <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus dicta error.</p>
         <a href="javascript:void(0)" class="btn btn-success btn-custom">Know More</a>
       </div>
     </div>
